...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, Instant.parse("2018-03-21T09:33:07Z"), "Partiu viagem", "Vou viajar para São Paulo. Abraços.", maria);
		Post post2 = new Post(null, Instant.parse("2018-03-23T06:52:25Z"), "Bom dia!", "Acordei feliz hoje!", maria);
